...
namespace Sparta_TextRPG
{
     ...
     * 
     * 트러블: 상점에서 어느 탭이건 0을 누르면 메인 메뉴가 아닌 프로그램이 종료되어 버림
     * 원인: 메인 메뉴의 상점 호출 뒷 부분이 break가 되어있었음
     * 해결: break -> continue
     * 
     * 트러블: 상점에 들어갈 때 마다 같은 아이템이 추가됨
     * 원인: AddItem이 상점에 들어갈 때 마다 동작하고 있음
     * 방안: 상점 레벨이 변화하지 않았다면 AddItem을 하지 않도록 수정
     * 
